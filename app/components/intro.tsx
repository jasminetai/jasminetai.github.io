export default function Intro() {
  return (
    <div className="w-full h-[95vh] flex flex-col justify-center">
      ...
      <div className="absolute top-[73%] -z-10 left-0 w-1/3 h-3 bg-gradient-to-r from-zinc-300/75 animate-[fade_1400ms_ease-in-out_300ms_alternate_infinite]"></div>
      <div className="absolute top-[76.5%] -z-10 left-0 w-1/5 h-4 bg-gradient-to-r from-zinc-300/75 animate-[fade_1400ms_ease-in-out_1200ms_alternate_infinite]"></div>
      <div className="absolute top-[83%] -z-10 left-0 w-1/2 h-2 bg-gradient-to-r from-zinc-300/75 animate-[fade_1400ms_ease-in-out_600ms_alternate_infinite]"></div>
      <div className="absolute top-[85.5%] -z-10 left-0 w-3/4 h-5 bg-gradient-to-r from-zinc-300/75 animate-[fade_1400ms_ease-in-out_alternate_infinite]"></div>
      <div className="absolute top-[90.5%] -z-10 left-0 w-2/5 h-3 bg-gradient-to-r from-zinc-300/75 animate-[fade_1400ms_ease-in-out_900ms_alternate_infinite]"></div>
